<template>
  <div>
      ...
      <el-table :data="orderlist" border stripe>
        ...
        <el-table-column label="操作">
          <template>
            ...
            <el-tooltip effect="dark" content="物流位置信息" placement="top-start" :enterable="false">
    ...
    <el-dialog title="物流进度" :visible.sync="progressVisible" width="50%">
      <!-- 时间线 -->
      <el-timeline>
        <el-timeline-item v-for="(activity, index) in progressInfo" icon='el-icon-more' color='#0bbd87' :key="index" :timestamp="activity.time">
          {{activity.context}}
        </el-timeline-item>
      </el-timeline>
    </el-dialog>
