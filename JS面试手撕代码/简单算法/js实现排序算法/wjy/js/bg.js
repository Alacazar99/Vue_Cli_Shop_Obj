var snowStorm = function(e, d) {
    ...
    this.usePositionFixed = this.useTwinkleEffect =
        false;
    ...
    a: {
        try {
            d.createElement("div").style.opacity = "0.6"
        } catch (F) {
            s = false;
            break a
        }
    ...
    this.scrollHandler = function() {
        ...
        if (!q && !a.flakeBottom && a.flakes)
            for (var c = a.flakes.length; c--;) a.flakes[c].active === 0 && a.flakes[c].stick()
    };
    this.resizeHandler =
        function() {
    ...
    this.resizeHandlerAlt = function() {
        ...
        l = a.flakeBottom ? a.flakeBottom : a.targetElement.offsetTop +
            a.targetElement.offsetHeight;
        n = parseInt(k / 2, 10)
    };
